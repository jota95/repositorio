...
import bases_de_datos.est_mat_base_de_datos;
    ...
    private void boton_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_guardarActionPerformed
        ...
        if (!tf_codigo.getText().equals("") ) {
            ...
            try {
                    ...
                    materia aux = (materia) combo_materias.getSelectedItem();
                    JOptionPane.showMessageDialog(rootPane, aux.getCodigo()+" "+aux.getNombre());

                    materia mat = new materia(aux.getCodigo(), 0,0,0);                    
                    mat.notafinal();
                    
                    est_mat_base_de_datos est_mat = new est_mat_base_de_datos();
                    if (est_mat.ingresar(tf_codigo.getText(), mat)) {
                        JOptionPane.showMessageDialog(rootPane, "Se agregado la materia al estudiante");
                        this.dispose();
                    }
                    else{
                   ...
                   // System.out.println("Nota final: "+mat.getNotafinal());
