...
public class consultar_notas extends javax.swing.JFrame {

   
    String codigo_estudiante;
    public consultar_notas(String codigo_est) {
        codigo_estudiante=codigo_est;
        System.out.println(codigo_est);
        initComponents();
        
        Consultar_estudiante con = new Consultar_estudiante();
        if(con.Consultar(codigo_estudiante)==true){
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(boton_regresar, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public void llenar_tabla(){
        try {
            ...
            ResultSet rs = s.executeQuery("select materia.codigo_materia ,materia.nombre_materia AS Materia , est_mat.nota_1 , est_mat.nota_2, est_mat.nota_3,est_mat.notas_final from est_mat,materia where codigo_estudiante = '" + codigo_estudiante + "' and est_mat.codigo_materia=materia.codigo_materia");
