...
import bases_de_datos.Eliminar_profesor;
import javax.swing.JOptionPane;




public class eliminar_profesor extends javax.swing.JFrame {
    ...
    private void boton_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_eliminarActionPerformed
        ...
        elim.eliminar_profesor_BD(tf_eliminar.getText());

        if (elim.getResultado().equals("eliminado")) {
            JOptionPane.showMessageDialog(rootPane, "Prfesor eliminado correctamente");
            this.dispose();
        }
        else{
            JOptionPane.showMessageDialog(rootPane, "Prfesor no registrado");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eliminar_profesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new eliminar_profesor().setVisible(true);
            }
        });
    }
